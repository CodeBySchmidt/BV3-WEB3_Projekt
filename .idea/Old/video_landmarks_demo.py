...
p = "C:/Users/Mauri/Desktop/BV3-WEB3_Projekt/testing/Utils/shape_predictor_68_face_landmarks.dat"
...
while True:
    ...
    for (i, rect) in enumerate(rects):
        ...
        for (x, y) in shape:
            ...
            cv2.line(image, (shape[2][0], shape[2][1]), (shape[31][0], shape[31][1]), (0, 255, 0), 2)
            ...
            cv2.line(image, (shape[35][0], shape[35][1]), (shape[14][0], shape[14][1]), (0, 255, 0), 2)
